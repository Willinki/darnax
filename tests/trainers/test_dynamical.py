...
# Tests
# -----------------------------
def test_train_step_runs(trainer: DynamicalTrainer, key: jax.Array) -> None:
...
def test_eval_step_runs(trainer: DynamicalTrainer, key: jax.Array) -> None:
...
def test_ctx_validation(trainer: DynamicalTrainer) -> None:
...
def test_jit_cache_reuse(trainer: DynamicalTrainer, key: jax.Array) -> None:
