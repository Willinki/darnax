...
# Tests
# -----------------------------
def test_train_step_runs(trainer: AltTrainer, key: jax.Array) -> None:
...
def test_eval_step_runs(trainer: AltTrainer, key: jax.Array) -> None:
...
def test_ctx_validation(trainer: AltTrainer) -> None:
...
def test_jit_cache_reuse(trainer: AltTrainer, key: jax.Array) -> None:
